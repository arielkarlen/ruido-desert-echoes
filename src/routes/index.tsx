      ...
      <main>
        <section id="inicio" className="hero-section relative flex min-h-[92svh] items-end">
          ...
          <div className="relative z-10 mx-auto w-full max-w-7xl px-5 pb-16 pt-32 md:px-8 md:pb-20">
            ...
            <h1 className="max-w-5xl font-display text-5xl font-black uppercase leading-[0.88] sm:text-8xl lg:text-[9rem]">Bajo el<br /><span className="text-primary">desierto</span></h1>
