      ...
      loadPromise = new Promise((resolve) => {
        this.startTransition(async () => {
          try {
            this.beforeLoad();
            if (historyAction)
              this._scroll.hash = historyAction === "PUSH" || historyAction === "REPLACE";
      ...
      const filter = (d) => {
        ...
        const gcTime =
          (d.preload
            ...
            : (route.options.gcTime ?? this.options.defaultGcTime)) ?? 3e5;
      ...
      children: [
        ...
        matchState.parentRouteId === "__root__"
          ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OnRendered, {}),
    ...
    var task = {
      ...
      ping: {
        ...
        reject: function (error) {
          request.aborted
            ? task.abortSet.delete(task) && finishAbortedTask(task, request, error)
  ...
  function renderElement(request, task, keyPath, type, props, ref) {
    if ("function" === typeof type)
      ...
      if (null === segment) {
        ...
        if (
          3 ===
          (task.formatContext = getChildFormatContext(prevContext$42, type, props)).insertionMode
        ) {
      ...
      switch (type) {
        ...
        case REACT_VIEW_TRANSITION_TYPE:
          ...
          if (null == props.name || "auto" === props.name)
            makeId(resumableState$jscomp$0, getTreeId(task.treeContext), 0);
        ...
        case REACT_SUSPENSE_TYPE:
          a: if (null !== task.replay) {
            ...
            var prevKeyPath$jscomp$5 = task.keyPath,
              ...
              newBoundary = createSuspenseBoundary(request, task.row, fallbackAbortSet, null, !1),
            ...
            if (null !== trackedPostpones) {
              ...
              task.componentStack =
                replaceSuspenseComponentStackWithSuspenseFallbackStack(suspenseComponentStack);
              try {
        ...
        switch (type.$$typeof) {
          case REACT_FORWARD_REF_TYPE:
            ...
            finishFunctionComponent(
              ...
              task,
              keyPath,
              renderWithHooks(request, task, keyPath, type.render, propsWithoutRef, ref),
              0 !== localIdCounter,
              actionStateCounter,
              actionStateMatchingIndex,
            );
                ...
                if (request.aborted)
                  ...
                  if (null === boundary$jscomp$0)
                    if (isRecoverableError(x$jscomp$0)) {
                      ...
                      (logRecoverableError(request, x$jscomp$0, errorInfo$jscomp$0),
  ...
  function abort(request, reason) {
    if (!(request.aborted || (11 !== request.status && 10 !== request.status))) {
      ...
      var isRecoverableReason =
        "object" === typeof reason && null !== reason && reason.$$typeof === REACT_RECOVERABLE_TYPE;
      request.aborted = !0;
...
var require_react_dom_server_node_production = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function getViewTransitionClassName(defaultClass, eventClass) {
    ...
    eventClass =
      null == eventClass || "string" === typeof eventClass ? eventClass : eventClass.default;
  ...
  function renderElement(request, task, keyPath, type, props, ref) {
    if ("function" === typeof type)
      ...
      if (null === segment) {
        ...
        if (
          3 ===
          (task.formatContext = getChildFormatContext(prevContext$43, type, props)).insertionMode
        ) {
          var preambleSegment = createPendingSegment(request, 0, null, task.formatContext, !1, !1);
          segment.preambleChildren.push(preambleSegment);
          task.blockedSegment = preambleSegment;
      ...
      switch (type) {
        ...
        case REACT_VIEW_TRANSITION_TYPE:
          ...
          if (null == name) {
            ...
            ((share ??= "auto"),
              prevContext$jscomp$0.tagScope & 4 && (resumableState$jscomp$1.instructions |= 128));
          ...
          task.formatContext = createFormatContext(
    ...
    if (null === segment) {
      ...
      try {
        ...
        if (
          ...
          if ("Maximum call stack size exceeded" === node.message) {
            segment =
              thrownValue$64 === SuspenseException ? getThenableStateAfterSuspending() : null;
            segment = spawnNewSuspendedRenderTask(request, task, segment);
            request.pingedTasks.push(segment);
            task.formatContext = previousFormatContext;
            task.context = previousContext;
...
export {
  ...
  executeRewriteInput as T,
  GLOBAL_TSR as _,
  replaceSsrResponse as a,
  createInlineCssStyleAsset as b,
  HeadContent as c,
  Outlet as d,
  lazyRouteComponent as f,
  useRouter as g,
  Link as h,
  normalizeSsrResponse as i,
  invariant as j,
  isNotFound as k,
  RouterProvider as l,
  createRootRouteWithContext as m,
  defineHandlerCallback as n,
  stripSsrResponseBody as o,
  createFileRoute as p,
  isSsrResponse as r,
  Scripts as s,
  renderRouterToStream as t,
  createRouter as u,
  TSR_SCRIPT_BARRIER_ID as v,
  resolveManifestCssLink as w,
  getScriptPreloadAttrs as x,
  createInlineCssPlaceholderAsset as y,
};
