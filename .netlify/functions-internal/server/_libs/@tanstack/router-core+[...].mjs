import {
  ...
  M as decodePath,
  O as rootRouteId,
  S as getStylesheetHref,
  _ as GLOBAL_TSR,
  b as createInlineCssStyleAsset,
  j as invariant,
  v as TSR_SCRIPT_BARRIER_ID,
  y as createInlineCssPlaceholderAsset,
...
function serializeString(str) {
  if (str.length >= MIN_JSON_STRINGIFY_LENGTH && !JSON_ESCAPE_DIFFERENCES.test(str))
      ...
      if (!(done || cancelled)) {
        ...
        Promise.resolve()
          .then(() => {
            ...
            return (_iterator$return = iterator.return) === null || _iterator$return === void 0
              ? void 0
...
function createBaseParserContext(mode, options) {
  ...
  return {
    ...
    compactArrayBufferViews:
      (_options$compactArray = options.compactArrayBufferViews) !== null &&
      _options$compactArray !== void 0
...
function getArrayBufferView(ctx, current) {
  ...
  const buffer = new Uint8Array(current.buffer, current.byteOffset, current.byteLength).slice()
    .buffer;
...
function deserializeArrayBuffer(ctx, node) {
  ...
  let buffer;
  if (source.length < MIN_NATIVE_BASE64_LENGTH || typeof Buffer === "undefined")
    ...
    valueNodes.push(
      createAsyncIteratorFactoryInstanceNode(
        ...
        parseSOS(
          ...
          ctx.type === 1
            ? createStream()
            : createStreamFromAsyncIterable(properties, ctx.state.cleanups),
        ),
      ),
    );
  }
...
export {
  ...
  toCrossJSONStream as d,
  getOrigin as i,
  fromJSON as l,
  attachRouterServerSsrUtils as n,
  createRawStreamRPCPlugin as o,
  getNormalizedURL as r,
  createSerializationAdapter as s,
  mergeHeaders as t,
  toCrossJSONAsync as u,
};
