...
import {
  C as resolveManifestAssetLink,
  D as isResolvedRedirect,
  E as isRedirect,
  O as rootRouteId,
  S as getStylesheetHref,
  T as executeRewriteInput,
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-I7UyHIfd.mjs");
