...
var logoFinal_png_asset_default = {
  ...
  r2_key:
    "a/v1/20af9d0a-64d0-4eae-9e93-eea65ed0c5f3/fd26880c-365f-4e69-8d98-2191f70c565c/logoFinal.png",
...
function MainHeader() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
    className:
      "fixed inset-x-0 top-0 z-50 border-b border-border/40 bg-background/80 backdrop-blur-md",
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
            ...
            children: menuOpen
              ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { size: 22 })
              : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Menu, { size: 22 }),
          }),
        ],
      }),
      menuOpen &&
...
function HeroBanner() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
    ...
    children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
            className:
              "max-w-5xl font-display text-5xl font-black uppercase leading-[0.88] sm:text-8xl lg:text-[9rem]",
            children: [
              "Aún de",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
            className:
              "mt-7 max-w-md text-base font-light leading-relaxed text-muted-foreground md:text-lg",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
        className:
          "absolute bottom-0 right-0 hidden border-l border-t border-border bg-background/75 px-7 py-4 font-mono text-[10px] uppercase text-muted-foreground lg:block",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
            id: "historia",
            className:
              "section-grid mx-auto grid max-w-7xl gap-14 px-5 py-28 md:grid-cols-2 md:px-8 md:py-40",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                        children:
                          "Formados entre el concreto de Buenos Aires y el polvo de las rutas del norte, R U I D O nace como una necesidad de materializar el peso de la tierra.",
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                        children:
                          "Nuestra música no busca la velocidad, sino la gravedad. Cada riff es una piedra; cada golpe de batería, un pulso tectónico que resuena en el pecho.",
                      }),
                    ],
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("figure", {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
                    ...
                    loading: "lazy",
                    className:
                      "h-full w-full object-cover grayscale transition duration-700 hover:grayscale-0",
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("figcaption", {
                    className:
                      "absolute bottom-4 left-4 font-mono text-[9px] uppercase text-foreground/70",
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
                      className:
                        "hidden max-w-xs text-right text-sm leading-6 text-muted-foreground md:block",
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
                                ...
                                loading: "lazy",
                                className:
                                  "h-full w-full object-cover grayscale transition duration-700 group-hover:scale-[1.02] group-hover:grayscale-0",
                              }),
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
                                className:
                                  "absolute left-3 top-3 font-mono text-[9px] text-foreground/60",
                                children: ["0", index + 1],
                              }),
                            ],
                          }),
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                    children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
                        className:
                          "font-display text-4xl font-black uppercase leading-none md:text-6xl",
                        children: "Dunas de sangre",
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
                        className: "mt-10 border-t border-border",
                        children: tracks.map(([number, title, duration]) =>
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                            "li",
                            {
                              className:
                                "track-row grid grid-cols-[2.5rem_1fr_auto] items-center border-b border-border py-4",
                              children: [
                                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
                            ...
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Youtube, { size: 16 }),
                              " YouTube",
                            ],
                          }),
                        ],
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
              className:
                "mx-auto flex max-w-7xl flex-col justify-between gap-12 px-5 md:flex-row md:items-end md:px-8",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
